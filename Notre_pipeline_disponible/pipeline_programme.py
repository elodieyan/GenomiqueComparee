...
# Ce pipeline crée beaucoup de fichier intermediaires

### parameters

analyzed_genomes = list_genomes # list contenant les genomes que vous souhaitez analysés
Id_perc = 70 # pourcentage d'identité
ev_treshold = 0.01 # seuil d'evalue (on ne prend que les ev inferieurs ou egales)
cover_perc = 60 # pourcentage de couverture
small_com = '' # si vous voulez mettre un commentaire dans le dossier de sortie de resultats

blast_outputs_path = '' # chemin d'acces au dossier contenant les blest_outputs
workpath = '' # chemin où on veut stocker les resultats et fichiers intermediaires
...
analyse_name = workpath \
            ...
            + small_com + '/' # nom qui va être donnés à votre dossier resultat
